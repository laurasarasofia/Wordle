    ...
    public static void main(String[] args) throws SAXException, IOException, ParserConfigurationException {
        ...
        for (int i = 0; i < 6; i++) { //for-loopissa käydään pelinrakenne
            ...
            if (sanalista.onkoListassa(arvaus) == true) { //testataan onko arvaus sanalistassa
                lauta.muodostaLauta(i, arvaus); //käyteään Pelilauta luokan metodia ja annetaan attribuuteiksi kierros ja arvattu sana

                VertaaSanat testi = new VertaaSanat(arvaus, vastaus); //luodaan VertaaSanat objekti, jossa testataan onko arvaus ja vastaus sama
                if (testi.vertaa() == true) { //jos ovat samat peli päättyyy
                    ...
                    System.out.println("Arvaukset loppu! oikea vastaus: " + Vari.CYAN + vastaus + Vari.RESET); //jos kierroksia ei ole jäljellä
